...
std::vector<std::vector<char>> detailsEnhancing(std::vector<std::vector<char>>& inputImage, int repetitions, std::vector<std::array<std::array<char, 2>, 2>>& sizeTwoGrids, std::vector<std::array<std::array<char, 3>, 3>>& sizeTwoRules, std::vector<std::array<std::array<char, 3>, 3>>& sizeThreeGrids, std::vector<std::array<std::array<char, 4>, 4>>& sizeThreeRules){
    for(int i = 0; i <= inputImage.size() - 1; i++){
        for(int j = 0; j <= inputImage[0].size() - 1; j++){
    ...
    if(inputImage.size() % 2 == 0){
        ...
        std::cout << "indiv divided" << "\n";
        for(auto& individualDivided : gridDivisions){
            for(int i = 0; i < individualDivided.size(); i++){
                for(int j = 0; j < individualDivided[i].size(); j++){
                    std::cout << individualDivided[i][j];
                }
                std::cout << "\n";
            }
            std::cout << "next part" << "\n";
        ...
        for(auto& individualDivided : gridDivisions){
            ...
            for(int i = 0; i < reversedOriginal.size(); i++){
                for(int j = 0; j < reversedOriginal[i].size(); j++){
                    std::cout << reversedOriginal[i][j];
                }
                std::cout << "\n";
            }
            ...
            std::cout << "rotated180" << "\n";
            for(int i = 0; i < rotated180.size(); i++){
                for(int j = 0; j < rotated180[i].size(); j++){
                    std::cout << rotated180[i][j];
                }
                std::cout << "\n";
            }
            for(int k = 0; k < 2; k++){
            ...
            std::cout << "reversed180" << "\n";
            for(int i = 0; i < reversed180.size(); i++){
                for(int j = 0; j < reversed180[i].size(); j++){
                    std::cout << reversed180[i][j];
                }
                std::cout << "\n";
            }
            ...
            std::cout << "rotated90Left" << "\n";
            for(int i = 0; i < rotated90Left.size(); i++){
                for(int j = 0; j < rotated90Left[i].size(); j++){
                    std::cout << rotated90Left[i][j];
                }
                std::cout << "\n";
            }
            ...
            std::cout << "reversed90Left" << "\n";
            for(int i = 0; i < reversed90Left.size(); i++){
                for(int j = 0; j < reversed90Left[i].size(); j++){
                    std::cout << reversed90Left[i][j];
                }
                std::cout << "\n";
            }
            ...
            std::cout << "rotated90Right" << "\n";
            for(int i = 0; i < rotated90Right.size(); i++){
                for(int j = 0; j < rotated90Right[i].size(); j++){
                    std::cout << rotated90Right[i][j];
                }
                std::cout << "\n";
            }
            ...
            std::cout << "reversed90Right" << "\n";
            for(int i = 0; i < reversed90Right.size(); i++){
                for(int j = 0; j < reversed90Right[i].size(); j++){
                    std::cout << reversed90Right[i][j];
                }
                std::cout << "\n";
            }
            ...
            for(int i = populateMatrixRow; i <= populateMatrixRow + 2; i++){
                ...
                selectRow++;
                selectCol = 0;
                std::cout << "row Matrix " << populateMatrixRow << "\n";
                std::cout << "col Matrix " << populateMatrixCol << "\n";      
            }
            populateMatrixCol += 3;
        ...
        for(auto& individualDivided : gridDivisions){
            ...
            std::cout << "rule " << ruleIndex << "\n";
            for(int i = 0; i < sizeThreeGrids[ruleIndex].size(); i++){
                for(int j = 0; j < sizeThreeGrids[ruleIndex][i].size(); j++){
                    std::cout << sizeThreeGrids[ruleIndex][i][j];
                }
                std::cout << "\n";
            }
            int selectRow{0};
...
int main(){
    ...
    int res{0};
    std::vector<std::vector<char>> outputImage = detailsEnhancing(inputPattern, 5, sizeTwoGrids, sizeTwoRules, sizeThreeGrids, sizeThreeRules);
