    ...
    for(int i = 0;; i = (i + 1) % 8){
        ...
        if(i == 0 && monkeys[0].size() > 0){
            for(int j = monkeys[0].size() - 1; j >= 0; j--){
                inspections[0]++;
                monkeys[0][j] *= 13;
                monkeys[0][j] = std::floor(monkeys[0][j] / 3);
            ...
            for(int j = monkeys[1].size() - 1; j >= 0; j--){
                inspections[1]++;
                monkeys[1][j] += 2;
                monkeys[1][j] = std::floor(monkeys[1][j] / 3);
            ...
            for(int j = monkeys[2].size() - 1; j >= 0; j--){
                inspections[2]++;
                monkeys[2][j] += 8;
                monkeys[2][j] = std::floor(monkeys[2][j] / 3);
            ...
            for(int j = monkeys[3].size() - 1; j >= 0; j--){
                inspections[3]++;
                monkeys[3][j] += 1;
                monkeys[3][j] = std::floor(monkeys[3][j] / 3);
            ...
            for(int j = monkeys[4].size() - 1; j >= 0; j--){
                inspections[4]++;
                monkeys[4][j] *= 17;
                monkeys[4][j] = std::floor(monkeys[4][j] / 3);
            ...
            for(int j = monkeys[5].size() - 1; j >= 0; j--){
                inspections[5]++;
                monkeys[5][j] += 3;
                monkeys[5][j] = std::floor(monkeys[5][j] / 3);
            ...
            for(int j = monkeys[6].size() - 1; j >= 0; j--){
                ...
                monkeys[6][j] = std::floor(monkeys[6][j] / 3);
            ...
            for(int j = monkeys[7].size() - 1; j >= 0; j--){
                inspections[7]++;
                monkeys[7][j] += 6;
                monkeys[7][j] = std::floor(monkeys[7][j] / 3);
